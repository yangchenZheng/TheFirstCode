...
/**每个Button之间的间隔*/
  ...
  private OnMenuFloatingActionButtonLongClickListener mOnMenuFloatingActionButtonLongClickListener;
  ...
  private void createAddButton(Context context) {
    ...
    mAddButton.setOnLongClickListener(new OnLongClickListener() {
      ...
      public boolean onLongClick(View v) {
          mOnMenuFloatingActionButtonLongClickListener.onLongClick(v);
        return true;
      }
    });
  ...
  public void setOnMenuFloatingActionButtonLongClickListener(OnMenuFloatingActionButtonLongClickListener
                                                                     onMenuFloatingActionButtonLongClickListener) {
    this.mOnMenuFloatingActionButtonLongClickListener = onMenuFloatingActionButtonLongClickListener;

  }
  public interface OnMenuFloatingActionButtonLongClickListener {
