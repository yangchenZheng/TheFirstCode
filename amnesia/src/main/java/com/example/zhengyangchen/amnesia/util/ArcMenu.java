...
public class ArcMenu extends ViewGroup implements OnClickListener,View.OnLongClickListener
{
	...
	public boolean onLongClick(View view) {
		mMenuLongClickListener.onLongClick(view);
		return true;
	}
	...
	public void setOnMenuLongClickListener(
			onMenuLongClickListener mMenuLongClickListener) {
		this.mMenuLongClickListener = mMenuLongClickListener;
	}
	...
	private void layoutCButton()
	{
		...
		case RIGHT_TOP:
			...
			break;
		case RIGHT_BOTTOM:
			l = getMeasuredWidth() - width-20;
			t = getMeasuredHeight() - height-20;
			break;
		}
