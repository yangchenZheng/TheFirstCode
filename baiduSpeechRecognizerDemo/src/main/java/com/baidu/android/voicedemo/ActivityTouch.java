...
public class ActivityTouch extends Activity implements RecognitionListener {
    ...
    private TextView txtLog;//显示log
    private Button btn;//开始按钮
    private Button setting;//设置按钮

    View speechTips;//讲话提示的图片

    View speechWave;//讲话的波浪
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);//启动设置的activity
            }
        });
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(this, new ComponentName(this, VoiceRecognitionService.class));//创建语音识别实例
        speechRecognizer.setRecognitionListener(this);//设置识别监听器
